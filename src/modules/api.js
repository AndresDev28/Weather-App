...
export async function getWeatherData(location) {
  const apiUrl = `${API_BASE_URL}${encodeURIComponent(location)}?key=${API_KEY}`; // asegura que la ubicación se codifique correctamente en la URL, evitando posibles errores debido a caracteres especiales.
